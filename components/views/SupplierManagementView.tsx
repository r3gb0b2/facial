                ...
                {suppliers.sort((a,b) => a.name.localeCompare(b.name)).map(supplier => {
                    ...
                    return (
                        <div key={supplier.id} className="bg-neutral-900/40 rounded-[2rem] overflow-hidden border border-white/5">
                            <div onClick={() => handleToggleSupplier(supplier.id)} className="p-6 flex flex-col md:flex-row justify-between items-center gap-6 cursor-pointer hover:bg-white/5 transition-all">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                                        ...
                                        {supplierAttendees.length === 0 && (
                                            <div className="col-span-full py-10 text-center border-2 border-dashed border-white/5 rounded-3xl">
                                                <p className="text-neutral-600 font-black uppercase text-[10px] tracking-[0.3em]">Nenhum convidado nesta lista ainda</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
