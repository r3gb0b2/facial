...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.513.43-1.37-.16-1.871a4.5 4.5 0 01-6.42-6.42l-1.87.162a4.5 4.5 0 01-1.871-.161m9.375 5.488a4.5 4.5 0 016.42 6.42m-6.42-6.42a4.5 4.5 0 00-6.42-6.42m6.42 6.42L12 12.75" />
    </svg>
);
...
export const FingerPrintIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.588 8.188M7.864 4.243a7.5 7.5 0 00-5.625 2.152L2.24 7.243m5.625-3.001V4.243m0 0a7.5 7.5 0 0111.636 0m-11.636 0L2.24 7.243m5.625 3.001a7.5 7.5 0 01-5.625-2.152L2.24 10.5m5.625 2.152a7.5 7.5 0 01.401 2.338l.493-4.93a7.5 7.5 0 015.158-4.243m-5.625 4.243a7.5 7.5 0 00-5.625 2.152L2.24 13.5m5.625 2.152V18m0 0a7.5 7.5 0 005.625-2.152L13.5 13.5m0 0a7.5 7.5 0 015.625 2.152l2.25-2.25m-10.125 0l-2.25-2.25" />
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM19.5 15.75l-.259 1.035a3.375 3.375 0 00-2.456 2.456L15.75 20.25l1.035.259a3.375 3.375 0 002.456 2.456L19.5 23.25l.259-1.035a3.375 3.375 0 002.456-2.456L22.75 20.25l-1.035-.259a3.375 3.375 0 00-2.456-2.456z" />
  </svg>
);
