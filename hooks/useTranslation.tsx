...
const translations = {
  pt: {
    ...
    'register.errors.selectCompany': 'Por favor, selecione sua empresa para continuar.',
    'register.errors.supplierLimitReached': 'O limite de cadastros para esta empresa foi atingido.',
    ...
    'register.form.companyPlaceholder': 'Clique para selecionar',
    ...
    'suppliers.createNewSupplierTitle': 'Criar Novo Fornecedor (Empresa)',
    ...
    'suppliers.nameLabel': 'Nome do Fornecedor/Empresa',
    ...
    'suppliers.noLinks': 'Nenhum fornecedor foi cadastrado ainda.',
