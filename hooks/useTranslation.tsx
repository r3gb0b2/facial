...
const ptTranslations = {
  ...
  "fastCheckin": {
    ...
    "apiPrompt": "Sua função é atuar como um sistema de verificação facial de alta precisão para a segurança de um evento. Analise as duas imagens fornecidas. A primeira é a foto oficial de registro e a segunda é uma foto tirada ao vivo. Sua única tarefa é determinar se a pessoa na foto ao vivo é a mesma da foto do registro. Leve em conta possíveis variações de iluminação, ângulo e expressão. Responda estritamente com 'Sim' se for a mesma pessoa, ou 'Não' se houver qualquer dúvida ou se forem pessoas diferentes.",
    "apiYes": "sim",
