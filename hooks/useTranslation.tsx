...
const ptTranslations = {
  ...
  "fastCheckin": {
    ...
    "apiPrompt": "Você é uma IA de segurança para check-in de eventos. Sua tarefa é verificar se as duas imagens a seguir são da mesma pessoa. A primeira imagem é do banco de dados de registro e a segunda é uma foto ao vivo. Compare os rostos com atenção. Responda apenas com 'Sim' se tiver certeza de que são a mesma pessoa, ou 'Não' caso contrário.",
    "apiYes": "sim",
