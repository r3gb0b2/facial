...
const translations: { [lang: string]: Translations } = {
  pt: {
    ...
    'admin.tabs.location': 'Localização Atual',
    'admin.tabs.validationPoints': 'Pontos de Validação',
    ...
    'attendeeCard.lastSeen': 'Visto por último em:',
    ...
    'validationPoints.title': 'Pontos de Validação de Setor',
    'validationPoints.createTitle': 'Criar Ponto de Validação',
    'validationPoints.nameLabel': 'Nome do Ponto',
    'validationPoints.namePlaceholder': 'Ex: Acesso Backstage',
    'validationPoints.sectorLabel': 'Setor a ser Validado',
    'validationPoints.createButton': 'Criar Ponto',
    'validationPoints.noPoints': 'Nenhum ponto de validação criado.',
    'validationPoints.noPointsSubtitle': 'Crie pontos para gerar links de scanner para sua equipe.',
    'validationPoints.deleteConfirm': (name: string) => `Tem certeza que deseja deletar o ponto "${name}"?`,
    'validationPoints.copyLinkTooltip': 'Copiar link do scanner',
    'sectorScanner.title': 'Validador de Setor',
    ...
    'location.noAttendees': 'Nenhum colaborador neste setor.',
    'location.searchPlaceholder': 'Buscar colaborador...',
  },
};
