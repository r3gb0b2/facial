...
const translations: { [lang: string]: Translations } = {
  pt: {
    ...
    'supplierAdmin.requestSectorChange': 'Trocar Setor',
    'supplierAdmin.sectorChangeRequested': 'Troca Solicitada',
    ...
    'sectorChangeModal.title': 'Solicitar Troca de Setor para',
    'sectorChangeModal.currentSector': 'Setor Atual',
    'sectorChangeModal.newSector': 'Novo Setor',
    'sectorChangeModal.selectSector': 'Selecione o novo setor',
    'sectorChangeModal.justification': 'Justificativa (Opcional)',
    'sectorChangeModal.justificationPlaceholder': 'Digite o motivo da troca',
    'sectorChangeModal.submitButton': 'Enviar Solicitação',
