...
const translations: { [lang: string]: Translations } = {
  pt: {
    ...
    'status.substitution_request': 'Aguardando Substituição',
    ...
    'attendeeDetail.substitutionRequestTitle': 'Solicitação de Substituição Pendente',
    'attendeeDetail.originalData': 'Dados Originais',
    'attendeeDetail.newData': 'Novos Dados',
    'attendeeDetail.approveButton': 'Aprovar Substituição',
    'attendeeDetail.rejectButton': 'Rejeitar Substituição',
