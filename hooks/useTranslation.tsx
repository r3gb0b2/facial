...
const translations = {
  pt: {
    ...
    // Register
    'register.title': 'Cadastro de Prestador de Serviço',
    'register.titleAdmin': 'Cadastrar Participante',
    ...
    'register.errors.selectCompany': 'Selecione uma empresa para continuar.',
    'register.errors.limitReached': 'O limite de vagas para esta empresa foi atingido.',
    'register.form.companyLabel': 'Selecione sua Empresa',
    'register.form.companyPlaceholder': 'Escolha uma empresa...',
    ...
    'supplierCategories.noCategoriesSubtitle': 'Adicione categorias para agrupar seus fornecedores (ex: Food Truck, Segurança).',
    ...
    'supplierCategories.deleteErrorInUse': (name: string) => `A categoria "${name}" não pode ser excluída pois está em uso por fornecedores.`,
    ...
    'supplierCategories.modal.namePlaceholder': 'Ex: Food Truck',
    ...
    // Suppliers
    'suppliers.generateTitle': 'Gerar Link por Categoria',
    'suppliers.categoryLabel': 'Categoria do Fornecedor',
    'suppliers.selectCategoryPlaceholder': 'Selecione uma categoria',
    'suppliers.copyLinkButton': 'Copiar Link da Categoria',
    'suppliers.addCompanyTitle': 'Adicionar Nova Empresa/Fornecedor',
    ...
    'suppliers.existingSuppliers': 'Empresas/Fornecedores Cadastrados',
    'suppliers.noSuppliers': 'Nenhuma empresa cadastrada para esta categoria ainda.',
